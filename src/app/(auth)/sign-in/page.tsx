...
const Page = () => {
  ...
  const continueAsCustomer = () => router.replace("/sign-in", undefined)
  ...
  return (
    <>
      <div className="container relative pt-2 flex-col items-center justify-center lg:px-0">
          ...
          <div className="grid gap-6 pb-2">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-backgound px-2 text-muted-foreground">or</span>
              </div>
            </div>
