          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order has processed and your assets are available to
                download below. We&apos;ve sent your receipt and order detailt
                to{" "}
              ...
              <p className="mt-2 text-base text-muted-foreground">
                We approciate your order, and we&apos;re currently processing
                      ...
                      <div className="flex-auto flex flex-col justify-between">
                        ...
                        {order._isPaid ? (
                          <a
                            ...
                            className="text-blue-600 hover:underline underline-offset-2 max-w-fit"
                          >
                            Download
                          </a>
                        ) : null}
